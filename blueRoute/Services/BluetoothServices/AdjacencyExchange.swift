...
extension BluetoothController {
    ...
    func prepareData() -> PendingExchange? {
        ...
        /*
          Need to find ATT MTU size and set it as upperBound Range
         **/
        var dataRange = Range(0...40)
    ...
    func startAdjacencyExchange(with vertex: Vertex) {
        ...
        self.pendingAdjacencyExchanges[vertex] = exchangePackage;
    }
    
    func sendDataChunk(for vertex: Vertex) {
        
        guard let pendingExchangeData = self.pendingAdjacencyExchanges[vertex] else {
            return;
        }
        ...
        self.pendingAdjacencyExchanges[vertex]?.chunksSent =  self.pendingAdjacencyExchanges[vertex]!.chunksSent + 1;
    }
}
